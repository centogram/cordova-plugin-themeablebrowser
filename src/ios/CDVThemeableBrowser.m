...
- (void)openInThemeableBrowser:(NSURL*)url withOptions:(NSString*)options
{
    ...
    self.themeableBrowserViewController.webView.scalesPageToFit = NO;
    self.themeableBrowserViewController.webView.mediaPlaybackRequiresUserAction = NO;
    self.themeableBrowserViewController.webView.allowsInlineMediaPlayback = YES;
